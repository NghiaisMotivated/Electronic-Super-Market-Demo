...
function updateTotal() {
    ...
    total = total.toFixed(0); // Giữ số đuôi của total
...
function cartBoxComponent(title, price, imgSRC) {
    return `
    <div class="cart-box">
    <img src="${imgSRC}" style = "width:130px; height: auto">
    ...
    <!-- remove cart -->
    <i style="color: black;" class='bx bx-message-rounded-x cart-remove'></i>
</div>`
...
function handdle_buyOrder() {
    if (itemsAdded.length <= 0) {
        ...
        alert('Thank you for order books in House of Knowlegde. Check your email and we will send you a bill !!')
    }
}